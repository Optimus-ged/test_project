...
class MissionProcess extends StatefulWidget {
  @override
  _MissionProcessState createState() => _MissionProcessState();
}

class _MissionProcessState extends State<MissionProcess> {
  int _currentStep = 0;
